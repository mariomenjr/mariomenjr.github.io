...
function create_fragment(ctx) {
  ...
  var block = {
    c: function create() {
      ...
      /*experienceYears*/
      ctx[0]);
      t7 = text(" años de experiencia desarrollando\n    aplicaciones orientadas a la inteligencia empresarial (o en inglés, Business\n    Intelligence) y actualmente soy parte del equipo de desarrollo de software\n    de Industrias Melang, MX. Principal encargado de la arquitectura Front-end.");
      t8 = space();
      p1 = element("p");
      b1 = element("b");
      ...
      b2 = element("b");
      t12 = text("Javascript");
      t13 = text(", mi principal fuerte, es un lenguaje fantástico y vérsatil, que se ha ganado\n    su lugar en ambientes de producción alrededor del mundo. En combinación con\n    la solidez de\n    ");
      b3 = element("b");
      t14 = text("C#");
      t15 = text("\n    y el\n    ");
      b4 = element("b");
      ...
      t23 = text(", la cuál recomiendo muchísimo; ver documentales, en especial si hablan de historia y humanidades; \n    y también me gusta conocer nuevos lugares junto a mi novia, hemos vistado ya varias ciudades de la unión americana.");
      t24 = space();
      p4 = element("p");
      t25 = text("Si te interesa ponerte en contacto conmigo, mi cuenta de twitter ");
      a0 = element("a");
      t26 = text("@mariomenjr");
      t27 = text(" es una buena opción. \n    También puedes escribirme un e-mail ");
      a1 = element("a");
      t28 = text("aquí");
      t29 = text(", aunque quizá quieres copiar y pegar mariomenjr@gmail.com.");
      t30 = space();
      p5 = element("p");
    ...
    l: function claim(nodes) {
      ...
      t13 = claim_text(p2_nodes, ", mi principal fuerte, es un lenguaje fantástico y vérsatil, que se ha ganado\n    su lugar en ambientes de producción alrededor del mundo. En combinación con\n    la solidez de\n    ");
      ...
      t23 = claim_text(p3_nodes, ", la cuál recomiendo muchísimo; ver documentales, en especial si hablan de historia y humanidades; \n    y también me gusta conocer nuevos lugares junto a mi novia, hemos vistado ya varias ciudades de la unión americana.");
      ...
      t25 = claim_text(p4_nodes, "Si te interesa ponerte en contacto conmigo, mi cuenta de twitter ");
      ...
      t27 = claim_text(p4_nodes, " es una buena opción. \n    También puedes escribirme un e-mail ");
      ...
      t29 = claim_text(p4_nodes, ", aunque quizá quieres copiar y pegar mariomenjr@gmail.com.");
    ...
    h: function hydrate() {
      ...
      add_location(b1, file, 18, 4, 747);
      attr_dev(p1, "class", "mb-5");
      add_location(p1, file, 17, 2, 726);
      add_location(b2, file, 23, 4, 991);
      add_location(b3, file, 26, 4, 1188);
      add_location(b4, file, 28, 4, 1211);
      attr_dev(p2, "class", "mb-5");
      add_location(p2, file, 22, 2, 970);
      add_location(b5, file, 33, 4, 1385);
      add_location(i, file, 35, 4, 1475);
      attr_dev(p3, "class", "mb-5");
      add_location(p3, file, 31, 2, 1354);
      attr_dev(a0, "href", "https://twitter.com/mariomenjr");
      attr_dev(a0, "class", "text-blue-500");
      add_location(a0, file, 39, 69, 1816);
      attr_dev(a1, "href", "mailto:mariomenjr@gmail.com");
      attr_dev(a1, "class", "text-blue-500");
      add_location(a1, file, 40, 40, 1957);
      attr_dev(p4, "class", "mb-5");
      add_location(p4, file, 38, 2, 1730);
      add_location(p5, file, 42, 2, 2094);
